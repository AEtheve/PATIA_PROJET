...
(colore ?n - noeud) ;; noeud n est colore
    ...
    (:action colorier2noeuds ;; colorier 2 noeuds voisins
        ...
        :effect (and (colore ?n1) (colore ?n2) (not(incolore?n1)) (not(incolore?n2))(decouleur ?n1 ?c1) (decouleur ?n2 ?c2))
    )

    (:action colorier1noeud ;; colorier 1 noeud 
        :parameters (?n1 ?n2 - noeud ?c1 ?c2 - color) ;; c1 et c2 sont les couleurs des noeuds n1 et n2
        :precondition (and (voisin ?n1 ?n2) (colore ?n1) (decouleur ?n1 ?c1)(incolore ?n2) (differentes_couleurs ?c1 ?c2))
        :effect (and (colore ?n2) (not(incolore?n2)) (decouleur ?n2 ?c2)) 
    )
    ...
    (:action marquerarrete ;; marquer une arrete
        ...
        :precondition (and (voisin ?n1 ?n2) (colore ?n1) (colore ?n2)(differentes_couleurs ?c1 ?c2)(decouleur ?n1 ?c1)(decouleur ?n2 ?c2)(entre ?a ?n1 ?n2) )
        :effect (marquee ?a)
    )
)
