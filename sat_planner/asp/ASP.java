...
public class ASP extends AbstractPlanner {
    ...
    public Plan solve(final Problem problem) {
        ...
        if (plan != null) {
            ...
            try {
                BufferedWriter writer = new BufferedWriter(new FileWriter("asp.out", true));
                // writer.write(plan.makespan() + " " + this.getStatistics().getTimeToSearch() + " " + problemName + "\n");
                // writer.write(plan.makespan() + " " + (endTime - startTime) + " " + problemName + "\n");
                // in second:
    ...
    return false; // retournez la valeur appropriée en fonction de votre logique
    }
    /**
